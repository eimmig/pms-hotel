      ...
      <table mat-table [dataSource]="dataSource" matSort>
        ...
        <ng-container matColumnDef="actions">
          ...
          <td mat-cell *matCellDef="let booking" class="text-center" style="width: 180px;">
            <button mat-button (click)="checkin(booking)" [disabled]="booking.status === 'E'">Checkin</button>
          </td>
        </ng-container>
...
export class CheckinComponent {
  ...
  fetchBooking() {
    this.bookingService.getAllBookingCheckin().subscribe(
      (response) => {
